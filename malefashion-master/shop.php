...
$records_per_page = 6;
$from_record_num = ($records_per_page * $currentPage) - $records_per_page;
...
// count total of all products in the database
            ...
            <div class="col-lg-9">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <nav aria-label="navigation">
                        <ul class="pagination">
                            <li class="page-item <?= $product->addClass($currentPage, 1, 'disabled') ?>">
